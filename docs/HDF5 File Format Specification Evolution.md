...
| Superblock v2 (compact; checksum; superblock extension) | — | — | ● | ○ | ○ | HDF5 1.8 | [1.8 file-format revision docs](https://support.hdfgroup.org/archive/support/HDF5/doc1.8/ADGuide/WhatsNew180.html) |
| Superblock v3 (SWMR flag in consistency bits) | — | — | — | ● | ○ | HDF5 1.10 (SWMR) | [SWMR design docs](https://support.hdfgroup.org/archive/support/HDF5/docNewFeatures/NewFeaturesSwmrDocs.html#SwmrDesignDocuments) |
...
| Link message (soft/hard/external, per-link encoding) | — | — | ● | ○ | ○ | HDF5 1.8 (new group format; external links) | [1.8 "group revisions"](https://support.hdfgroup.org/archive/support/HDF5/doc1.8/RM/RM_H5G.html#Group-GroupStyles) |
| Link Info / Group Info messages | — | — | ● | ○ | ○ | HDF5 1.8 (compact vs. dense groups) | [1.8 "group revisions"](https://support.hdfgroup.org/archive/support/HDF5/doc1.8/RM/RM_H5G.html#Group-GroupStyles) |
| Fractal heap (`FRHP`/`FHDB`/`FHIB`) for dense links | — | — | ● | ○ | ○ | HDF5 1.8 (scalable groups, creation order) | [Fractal heap design doc](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/PrivateHeap.pdf)
...
| Extensible Array chunk index (`EAHD`/`EAIB`/`EASB`/`EADB`) | — | — | — | ● | ○ | HDF5 1.10 (append-mostly datasets, SWMR) | [File Format Changes in HDF5 1.10.0](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/2015-09-28-RFC-HDF5-1.10.0-File-Format-Superblock-Changes-EP.docx.pdf) |
...
| Datatype v4 (revised reference types) | — | — | — | ● | ○ | HDF5 1.12 (new references) | [RFC: Update to HDF5 References](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/RFC_Update_to_HDF5_References.pdf) |
| Datatype v5 + Complex class (11) | — | — | — | — | ● | HDF5 2.0 (`H5T_COMPLEX`) | [RFC: Adding support for 16-bit floating point and Complex number datatypes to HDF5](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/RFC__Adding_support_for_16_bit_floating_point_and_Complex_number_datatypes_to_HDF5.pdf), [RFC: New Datatypes](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/new_datatypes.pdf) |
...
| Free-space manager (`FSHD`/`FSSE`) + File Space Info msg | —* | —* | — | ● | ○ | HDF5 1.10 (*1.0/1.1 declared free-space format "undefined") | [RFC: HDF5 File Space Management: Paged Aggregation](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/paged_aggregation.pdf), [HDF5 File Space Management](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/FileSpaceManagement.pdf) |
...
| Revised reference encoding (attr/external refs) | — | — | — | ● | ○ | HDF5 1.12 | [RFC: Update to HDF5 References](https://support.hdfgroup.org/releases/hdf5/documentation/rfc/RFC_Update_to_HDF5_References.pdf) |
