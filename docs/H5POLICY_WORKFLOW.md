...
Registry checks currently account for **327 finding codes** and **0 semantic-
backlog entries**. Static enumeration resolves **1018 in-pickle message
...
The current invariant manifest contains **408 named invariants across 16
